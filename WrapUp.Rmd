...
```{r}
vax.intro.date= as.Date('2008-01-01')

months_until_second_knot = 12 #how many months between vaccine intro and start of eval period

months_until_third_knot = 999  #if there is a 2nd change in slope, how many months after vaccine intro does it occur? if no 2nd change, set as 999
